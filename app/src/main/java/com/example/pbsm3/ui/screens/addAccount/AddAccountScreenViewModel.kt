...
import com.example.pbsm3.model.service.repository.AccountRepository
...
//        launchCatching {
//            val documentID = accountRepository.add(Account(
//                name = uiState.value.accountName,
//                balance = uiState.value.accountBalance
//            ))
//            Log.d(TAG,
//                "account was added with document ID: $documentID")
//        }
    }
}